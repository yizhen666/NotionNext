...
const BLOG = {
  AUTHOR: '翼轸', // 作者
  BIO: '一个普通的干饭人', // 作者简介
  LINK: 'https://eezhen.vercel.app', // 网站地址
  AVATAR: '/avatar.png', // 个人头像 默认取public目录下的avatar.png
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '434be7b0e06a48f8a6522d99b536c87f', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'z@ezhen.onmicrosoft.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '3d1885d0-de50-4be4-8595-d8393eff2b5c', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
